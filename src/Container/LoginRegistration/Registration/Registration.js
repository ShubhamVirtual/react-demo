...
import validateRigistration from "./RegistrationValidation";
...
export default function Registration(props) {
  ...
  const _validateForm = () => {
    ...
    let response = validateRigistration(formFields, applyCheck);
  ...
  const _handleSubmit = (event) => {
    ...
    if (_validateForm()) {
      ...
      console.log("Post: ", fields.password);
    }
  };
        ...
        <section className="Widget_widget__16nWC">
            <div className="widget-auth widget-p-lg">
                ...
                <div className="d-flex align-items-center justify-content-center pb-3">
                    <p className="auth-header mb-0">Registration</p>
                ...
                <form onSubmit={(event) => _handleSubmit(event)}>
                    <div className="mb-3 mt-3">
                        ...
                        />
                        <div className="errorMsg text-danger">{errors.name}</div>
                    </div>
                    <div className="mb-3 mt-3">
